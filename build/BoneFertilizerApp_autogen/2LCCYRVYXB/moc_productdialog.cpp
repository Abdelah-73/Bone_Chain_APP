...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ProductDialog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_ProductDialog_t qt_meta_stringdata_ProductDialog = {
    {
        QT_MOC_LITERAL(0, 13),  // "ProductDialog"
...
Q_CONSTINIT static const uint qt_meta_data_ProductDialog[] = {
...
Q_CONSTINIT const QMetaObject ProductDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ProductDialog.offsetsAndSizes,
    qt_meta_data_ProductDialog,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_ProductDialog_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ProductDialog, std::true_type>,
        // method 'handleSave'
